...
const fetchSearchResults = (searchString) => {
  return fetch(
    `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${searchString}&key=AIzaSyCzITvmAO8Q1gHaYdIxMk2YhJdjdylqbNM`
  )
    .then((repsonse) => repsonse.json())
    .then((data) => {
      return createNewVideoObject(data, globalObject.videoSearchResult);
    })
