...
const eventListeners = () => {
  ...
  const mainVideoContainerTitle = document.querySelector(
    ".mainContainer__videoContainer__h3"
  );

  const mainSearchInput = document.querySelector(".header__input input");
  const history = document.querySelector(
    ".mainContainer__sideNavigation__history"
  );
  const historyMobile = document.querySelector(
    ".mainContainer__modalNavigation__history"
  );
  const headerMenu = document.querySelector(".header__menu");
  const sideMenu = document.querySelector(".sideMenu");
  const sideMenuClose = document.querySelector(".sideMenuClose");
  const trendingButton = document.querySelector(
    ".mainContainer__sideNavigation__trending"
  );
  const trendingButtonModal = document.querySelector(
    ".mainContainer__modalNavigation__trending"
  );
  const mainContainerModalNavigationHome = document.querySelector(
    ".mainContainer__modalNavigation__home"
  );
  const sideMenuMenu = document.querySelector(".sideMenu__menu");
  const mainContainerSideNavigationHome = document.querySelector(
    ".mainContainer__sideNavigation__home"
  );
  ...
  const trendingAction = [
    trendingButton,
    trendingButtonModal,
    mainContainerSideNavigationHome,
    mainContainerModalNavigationHome,
  ];
  ...
  mainSearchInput.addEventListener("keypress", (e) => {
    if (e.key === "Enter") {
      ...
      localStorage.setItem(
        "searchResults",
        JSON.stringify(globalObject.searchesPerformed)
      );
